...
var Ng2SliderComponent = (function () {
    ...
    __decorate([
        core_1.Input()
    ], Ng2SliderComponent.prototype, "min");
    __decorate([
        core_1.Input()
    ], Ng2SliderComponent.prototype, "max");
    __decorate([
        core_1.Input()
    ], Ng2SliderComponent.prototype, "startValue");
    __decorate([
        core_1.Input()
    ], Ng2SliderComponent.prototype, "endValue");
    __decorate([
        core_1.Input()
    ], Ng2SliderComponent.prototype, "stepValue");
    Object.defineProperty(Ng2SliderComponent.prototype, "value",
        __decorate([
            core_1.Input()
        ], Ng2SliderComponent.prototype, "value", Object.getOwnPropertyDescriptor(Ng2SliderComponent.prototype, "value")));
    __decorate([
        core_1.Input()
    ], Ng2SliderComponent.prototype, "normalHandlerStyle");
    __decorate([
        core_1.Input()
    ], Ng2SliderComponent.prototype, "slidingHandlerStyle");
    __decorate([
        core_1.Input()
    ], Ng2SliderComponent.prototype, "rangeRibbonStyle");
    __decorate([
        core_1.Input()
    ], Ng2SliderComponent.prototype, "skin");
    __decorate([
        core_1.Input()
    ], Ng2SliderComponent.prototype, "styleBlock");
    __decorate([
        core_1.Output('onRangeChanged')
    ], Ng2SliderComponent.prototype, "rangeChangedEvent");
    __decorate([
        core_1.ViewChild('ribbon')
    ], Ng2SliderComponent.prototype, "ribbon");
    __decorate([
        core_1.ViewChild('start')
    ], Ng2SliderComponent.prototype, "startRef");
    __decorate([
        core_1.ViewChild('end')
    ], Ng2SliderComponent.prototype, "endRef");
    __decorate([
        core_1.ViewChild('startInput')
    ], Ng2SliderComponent.prototype, "startInputRef");
    __decorate([
        core_1.ViewChild('endInput')
    ], Ng2SliderComponent.prototype, "endInputRef");
    __decorate([
        core_1.ContentChildren(ng2_styled_directive_1.Ng2StyledDirective)
    ], Ng2SliderComponent.prototype, "_styledDirectives");
